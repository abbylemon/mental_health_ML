...
| [natural_language_processsing.ipynb](./natural_language_processing.ipynb) | This notebook includes all of the natural language processing analysis work done for this project, including sentiment analysis and building text classification models. |
| [ml_model.ipynb](./ml_model.ipynb) | This notebook includes the code used to build the machine learning models used to classify whether an employee would be willing to seeek mental health treatment. |
